    ...
    <>
      <section className="flex mx-auto flex-col md:flex-row justify-between max-w-7xl p-6">
        <div className="justify-center flex flex-col md:w-1/2">
          ...
          <p className="font-medium mb-5">Upload an image to remove the background and make it transparent. This app uses AI to detect the image background so accurate results are not guaranteed.</p>
          <div className="my-4">
